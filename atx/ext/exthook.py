...
class ExtensionImporter(object):
    ...
    This makes it possible to transition from the old atxext.name to the
    newer atx_name without people having a hard time.
    """
    ...
    def find_module(self, fullname, path=None):
        if fullname.startswith(self.prefix) and \
           fullname != 'atx.ext.ExtDeprecationWarning':
            return self
    ...
    def load_module(self, fullname):
        ...
        # warnings.warn(
        #     "Importing atx.ext.{x} is deprecated, use atx_{x} instead."
        ...
        for path in self.module_choices:
            ...
            if realname.startswith('atxext.'):
                warnings.warn(
                    "Detected extension named atxext.{x}, please rename it "
                    "to atx_{x}. The old form is deprecated."
